...
=head1 SYNOPSIS
  ...
  my $box = ODE::Collision::Box->create_box( 3, 2.1, 4 );

=head1 METHODS

=head2 create_box( $lx, $ly, $lz )
...
Returns a new box geometry. The point of reference for coordinates is its center.


=head2 get_lengths()

  my ($lx, $ly, $lz) = get_lengths();

Get the side lengths of a box.


=head2 set_lengths($lx, $ly, $lz)
...
Documentation almost taken verbatim from L<ODE's|http://opende.sourceforge.net/docs/group__collide__box.html>.
